...
resource "aws_iam_role" "plane_ee" {
  name = "plane-ee-ec2-role"
...
# Instance profile
resource "aws_iam_instance_profile" "plane_ee" {
  name = "plane-ee-instance-profile"
  role = aws_iam_role.plane_ee.name
}
...
resource "aws_iam_role_policy" "lambda_permissions" {
  name = "plane-ee-lambda-permissions"
